...
class Range(object):
    ...
    def include_min(self):
        """return include_min property"""
        return self._include_min

    @property
    def include_max(self):
        """return include_max property"""
        return self._include_max

    @property
    def inverse(self):  
        """# type: () -> _Union[Range, Union]"""
        if self.is_any():
            return EmptyRange()
    ...
    def difference(self, other):  
        """# type: (_Union[Range, Union]) -> _Union[Range, Union]"""
        if other.is_empty():
            return self
