...
from core.version_decide.semver.empty_constraint import EmptyConstraint
from core.version_decide.semver.exceptions import ParseVersionError
from core.version_decide.semver.patterns import COMPLETE_VERSION
from core.version_decide.semver.version_constraint import VersionConstraint
from core.version_decide.semver.version_range import VersionRange
from core.version_decide.semver.version_union import VersionUnion
...
class Version(VersionRange):
    ...
    def union(self, other):  
        """# type: (VersionConstraint) -> VersionConstraint"""
        from semver.version_range import VersionRange
